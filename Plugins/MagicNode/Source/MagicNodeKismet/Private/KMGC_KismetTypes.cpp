...
uint32 UMGC_SemanticDB::DBCicles = 0;
EDatabaseState UMGC_SemanticDB::DBState = EDatabaseState::READY;
FAutoDeleteAsyncTask<TASK_BuildAutoCompleteData>* UMGC_SemanticDB::DBAsyncTask = nullptr;
...
void UMGC_SemanticDB::UpdateExtensions() {
	...
	for (TObjectIterator<UClass>IT; IT; ++IT) {
		...
		if (UMGC_SemanticDB::DBCicles>=108000) {break;}
	}
	//
