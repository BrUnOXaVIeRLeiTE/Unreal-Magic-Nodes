...
DECLARE_STATS_GROUP(TEXT("MGC.Editor"),STATGROUP_MGC,STATCAT_Advanced);
DECLARE_CYCLE_STAT(TEXT("MGC.AutoComplete"),STAT_AutoComplete,STATGROUP_MGC);

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

class TASK_BuildAutoCompleteData;
...
public:
	static uint32 DBCicles;
	static EDatabaseState DBState;
	static FAutoDeleteAsyncTask<TASK_BuildAutoCompleteData>* DBAsyncTask;
};
